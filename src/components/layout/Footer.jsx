...
const Footer = () => (
  <footer className="footerSec bg-blue-950 text-white py-12 px-4 sm:px-6 md:py-16 md:px-6">
    <div className="container mx-auto">
      <div className="fcontentBox grid grid-cols-1 md:grid-cols-12 gap-10">
        {/* Left Column - Logo + Social Icons */}
        <div className="fSec md:col-span-3 flex flex-col items-center md:items-start text-center md:text-left">
          <img
            src="/White.png"
            alt="Uddheshya Group"
          ...
          {/* Slogan Text */}
          <p className="ftext text-base sm:text-lg font-semibold mb-6 text-green-400 max-w-xs">
            We Build, Discover, Design, Host and Code.
          </p>

          {/* Social Media Icons */}
          <div className="smedia flex space-x-6 justify-center md:justify-start">
            {/* social icons here unchanged */}
            <a
              href="https://www.facebook.com/profile.php?id=61578545593783"
              target="_blank"
              rel="noopener noreferrer"
              className="fb hover:text-green-400 transition duration-300"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="insta hover:text-green-400 transition duration-300"
            >
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="linkedin hover:text-green-400 transition duration-300"
            >
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="tiktok hover:text-green-400 transition duration-300"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="youtube hover:text-green-400 transition duration-300"
            >
        ...
        <div className="md:col-span-3 text-center md:text-left">
          <h3 className="headText text-lg font-semibold mb-6 text-green-400 uppercase tracking-wider">
            Useful Links
          </h3>
      ...
      {/* Copyright */}
      <div className="copyrightSec mt-12 pt-8 border-t border-gray-700 text-center text-gray-400 text-sm">
        <p>
